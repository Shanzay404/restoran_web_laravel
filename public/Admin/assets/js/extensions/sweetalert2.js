document.getElementById('basic1').addEventListener('click', (e) => {
...
// document.getElementById('statusChangeBtn').addEventListener('click', async (e) => {
...
document.getElementById('statusChangeBtn').addEventListener('click', async () => {
    ...
    if (result.isConfirmed) {
        Swal.fire('Status Changed!', 'The category status has been updated.', 'success');
    } else if (result.dismiss === Swal.DismissReason.cancel) {
        Swal.fire('Cancelled', 'The category status remains unchanged.', 'error');
    }
});
